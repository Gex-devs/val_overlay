...
# Send messages from the queue to the server. Not using this really
...
async def request_json():
    ...
    while True:
        ...
        if(f!="{}"):
            ...
            url_temp = 'http://192.168.1.227:8080/print'
            try:
                
                x = requests.post(url_temp, data =  "Ayo Get this")
            except:
                pass
        ...
        if(party_data_json_diff!="{}"):
            ...
            logging.info(original_party_second_response)
